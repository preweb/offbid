...
public class RegisterBid extends HttpServlet 
{
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException 
    {
       ...
       if(Services.insertBidData(inputFile, customer.getCustomerID(), Integer.parseInt(quantity), Double.parseDouble(amount)))
        {
            RequestDispatcher rd = request.getRequestDispatcher("SuccessfulBid.jsp");
